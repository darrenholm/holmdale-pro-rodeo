...
const tokenOptions = [
    { amount: 0.01, label: '$0.01 Tokens', color: 'bg-blue-500' },
    { amount: 0.02, label: '$0.02 Tokens', color: 'bg-green-500' },
    { amount: 0.05, label: '$0.05 Tokens', color: 'bg-purple-500' },
    { amount: 0.10, label: '$0.10 Tokens', color: 'bg-orange-500' }
];
