    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        transition={{ duration: 0.8 }} className="mb-12 px-24 py-6 absolute top-8 left-10z-20">
          ...
          transition={{ duration: 0.8 }} className="flex justify-end md:justify-center">
                    ...
                    <span className="bg-green-600/20 text-green-400 mt-48 mb-1 pt-2 pr-16 pl-2 text-sm font-medium text-center uppercase tracking-wider rounded-full inline-block border border-green-500/30 -mb-4">EXPERIENCE THE THRILL
